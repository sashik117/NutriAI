...
NutriAI is organized as a small production-style fullstack app:
...
- `src/domain/meal-plan/mealPlanModel` contains weekly meal-plan normalization, fallback meals, local cache signatures, and display helpers.
